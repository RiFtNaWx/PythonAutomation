...
from logic_tests import test_tp
#from config import *
...
def main():
    ...
    try:
        ...
        for vcc in VCC_LIST:
            ...
            results.append(test_tp(instr, vcc))
          #  results.append(test_tidle(instr, vcc))
          #  results.append(test_tdis(instr, vcc))
          #  results.append(test_ten(instr, vcc))
