...
See also [HANDOVER.md](../HANDOVER.md) and [LOGIC_DC_HANDOVER.md](LOGIC_DC_HANDOVER.md). **JH DM unlock != Datasheet CONFIRM** -- scale-wave UNCONFIRMED numbers HOLD.

**RS1GT34 VOL board-change resume:** recable PSU CH2 Y-load before VOL; do not invent VOL loads.
