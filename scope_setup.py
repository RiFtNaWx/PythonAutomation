...
def scope_single_capture(scope, ch, trig_level):
    
    # Trigger: rising edge  
    scope.write(':TRIG:MODE EDGE')
    scope.write(f':TRIG:EDGE:SOUR CHAN{ch}')
    scope.write(':TRIG:EDGE:SLOP POS')   # rising edge
    scope.write(f':TRIG:EDGE:LEV {trig_level}')         # adjust level for your signal
    scope.write(':TRIG:SWE NORM')        # normal mode
